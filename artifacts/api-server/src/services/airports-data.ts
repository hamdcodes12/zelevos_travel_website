...
export function findAirports(query?: string, excludeIata?: string): AirportData[] {
  ...
  return [...exactIata, ...prefixMatches, ...substringMatches].slice(0, 15);
}

export function getAirport(iata: string): AirportData | undefined {
  if (!iata) return undefined;
  return AIRPORTS.find((a) => a.iata === iata.trim().toUpperCase());
}
